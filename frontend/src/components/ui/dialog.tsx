...
function DialogFooter({
  ...
  return (
    <div
      ...
      className={cn(
        "-mx-4 -mb-4 flex flex-col-reverse gap-2 rounded-b-md border-t p-3 px-4 sm:flex-row sm:justify-end",
        className
      )}
      {...props}
    >
